                    ...
                    <tbody>
                        @foreach ($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>{{ $row->namajenis }}</td>
                                <td>{{ $row->namaowner }}</td>
                                <td>{{ number_format($row->hargaboat) }} / Hari</td>
                                <td>
                                    <a class="btn btn-info btn-sm" href='{{ url("admin/master/$prefix/edit/$row->kodeboat") }}'><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-danger btn-sm" onclick="return confirm('Hapus data {{ $row->kodeboat }} ? ')" href='{{ url("admin/master/$prefix/acthapus/$row->kodeboat") }}'><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
