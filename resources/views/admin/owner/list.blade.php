                    ...
                    <tbody>
                        @foreach ($rows as $row)
                            ...
                            <tr>
                                <td>{{ $row->kodeowner }}</td>
                                <td>{{ $row->namaowner }}</td>
                                <td>{{ $row->emailowner }}</td>
                                <td>{{ $row->alamatowner }}</td>
                                <td>{{ $row->noteleponowner }}</td>
                                <td>
                                    <a class="btn btn-info btn-sm" href='{{ url("admin/master/$prefix/edit/$row->kodeowner") }}'><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-danger btn-sm" onclick="return confirm('Hapus data {{ $row->kodeowner }} ? ')" href='{{ url("admin/master/$prefix/acthapus/$row->kodeowner") }}'><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
