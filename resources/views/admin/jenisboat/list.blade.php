                    ...
                    <tbody>
                        @foreach ($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>{{ $row->namajenis }}</td>
                                <td>
                                    <a class="btn btn-info btn-sm" href='{{ url("admin/master/$prefix/edit/$row->kodejenis") }}'><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-danger btn-sm" onclick="return confirm('Hapus data {{ $row->kodejenis }} ? ')" href='{{ url("admin/master/$prefix/acthapus/$row->kodejenis") }}'><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
